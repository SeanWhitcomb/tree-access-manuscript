...
In this study, I evaluated distributional justice concerns related to residential tree canopy cover and park tree access in Phoenix, Arizona. My findings show that racial and ethnic composition and social deprivation reliably predict the residential tree canopy cover (RTCC) within block groups in the city. There is a significant negative association between RTCC and the proportion of Black residents; a similar association is present with the proportion Hispanic residents; and there is a positive association between area deprivation index (ADI) rank and RTCC. In short, Phoenix neighborhoods with higher minority populations and lower socioeconomic status have less residential tree canopy cover.

However, the association between park tree canopy access (PTAS) and demographic factors is more nuanced. PTAS is not significantly associated with Hispanic population proportion, but there is a positive association with the Black population proportion. And there is a strong positive correlation between PTAS and ADI rank. On average, Phoenix residents have equal access to park tree canopy cover, regardless of the proportion of Hispanic residents within a block group. However, block groups with larger Black populations and greater deprivation have better access to park tree canopy than other block groups. This is likely because Phoenix parks are concentrated in the south and center of the city where Black populations are highest and deprivation is more widespread. Given the sprawling nature of Phoenix growth, parks near the city center are likely to be older, allowing more time for the tree canopy to develop compared to newer suburban parks.

Given that RTCC is inequitably distributed in Phoenix, while PTAS is higher in socially vulnerable neighborhoods, public parks do seem to serve as tree canopy refuges in areas where this canopy is needed the most. Tree canopy refuge block groups (those with low RTCC and high PTAS) are more likely to have large Black populations and high socioeconomic deprivation.
