...
Median household income is often used as a predictor variable in green space access research \[ @lara-valencia2018, @zhou2013\], but it was excluded from this study due to its high correlation with ADI rank (*r* = -0.70) and the presence of 50 block groups with suppressed income estimates in the ACS data.
