...
This study evaluated distributional justice concerns related to residential tree canopy cover and park tree access in Phoenix, Arizona. It addressed the question of whether the racial/ethnic composition and socioeconomic deprivation of a block group reliably predicts its residential tree canopy cover. It also addressed the extent to which demographic factors predict public park tree canopy access. Finally, it addressed the question of whether public parks serve as tree canopy refuges in low-residential canopy block groups and whether this pattern is associated with the race/ethnicity or socioeconomic status of the residents.

### Residential tree canopy cover inequity

I found that ublic parks contribute to the total tree canopy cover found within Phoenix neighborhoods. Although the average increase in tree cover is small, it is statistically significant. On average, Phoenix neighborhoods that contain parks have higher tree canopy cover than they would have if the parks were not present. Although Phoenix parks contribute to the limited tree cover in this hot, arid city, the tree cover is not evenly distributed across all parks. This finding validates the use of residential tree canopy cover (RTCC) as an outcome variable as distinct from total tree canopy cover (TTCC).
...
Use of ADI limits the ability to isolate
