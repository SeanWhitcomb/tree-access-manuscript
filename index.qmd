...
![Tree canopy access categories](images/map_access.png){#fig-canopy-access-map fig-alt="HH block groups are mostly in the northeast of Phoenix; HL block groups are in the eastern part; LH are mostly in the central part; LL are mostly on the edges of the city"}
